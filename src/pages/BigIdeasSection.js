...
import { BigIdeas } from '../data/Saas';
...
const BigIdeasSection = ({
  ...
  return (
    <BigIdeasSectionWrapper id="feature_section">
      <Container>
        <Box {...sectionHeader}>
          <Text content="BIG IDEAS" {...sectionSubTitle} />
          <Heading content="The 7 Big Ideas in Computing" {...sectionTitle} />
        </Box>
        <Box className="row" {...row}>
          {BigIdeas.map((feature, index) => (
